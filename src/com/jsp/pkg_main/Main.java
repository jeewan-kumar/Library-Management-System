package com.jsp.pkg_main;
import java.util.Scanner;

import com.jsp.pkg_book.Book;
import com.jsp.pkg_book.BookManager;
import com.jsp.pkg_exception.BookNotFoundException;
import com.jsp.pkg_exception.StudentNotFoundException;
import com.jsp.pkg_person.Student;
import com.jsp.pkg_person.StudentManager;
import com.jsp.pkg_transaction.BookTransactionManager;
			...
			else if (choice == 2) // user is a Librarian
			{
				...
				do {
					...
					case 22: // search a book by isbn
						int search_isbn;
						System.out.println("Enter ISBN of th  Book you want to Search : ");
					...
					System.out.println("Please enter the isbn to dlete the record");
					int delete_isbn;
					...
					try{
						...
						System.out.println(book + " has been deleted from records.");
					}
					catch (BookNotFoundException bnfe){
						System.out.println(bnfe);
						}
